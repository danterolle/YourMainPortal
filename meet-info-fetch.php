...
$query = "SELECT M.user_id creator, M.meeting_id, count(*) as partecipanti, M.place, M.title, DATE_FORMAT(M.date, '%Y-%m-%d') date , DATE_FORMAT(M.date, '%h:%i') time, lat, lng from meeting M join partecipate P on M.meeting_id=P.meeting_id
